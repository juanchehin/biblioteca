    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                 {!! Form::open(['url' => 'prestamosDestroy']) !!}
                 <span id="escribir">
                
                </span>
               
                <button type="submit" id="eliminarPrestamo" name="eliminarPrestamo" class="btn btn-delete btn-danger" onClick="dte()">Eliminar</button>
